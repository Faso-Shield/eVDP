...
class AuditAction(models.TextChoices):
    ...
    MFA_ENROLLED = "MFA_ENROLLED", "Double authentification activee"
    MFA_VERIFIED = "MFA_VERIFIED", "Second facteur valide"
    MFA_FAILED = "MFA_FAILED", "Second facteur refuse"
    MFA_RESET = "MFA_RESET", "Double authentification reinitialisee"
