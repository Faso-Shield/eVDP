...
class AuditAction(models.TextChoices):
    ...
    CASE_ESCALATED = "CASE_ESCALATED", "Case escaladé"
    ...
    BOUNTY_SENT_BACK = "BOUNTY_SENT_BACK", "Récompense renvoyée au proposant"
    WALLET_CREDITED = "WALLET_CREDITED", "Wallet crédité"
    WALLET_ADJUSTED = "WALLET_ADJUSTED", "Écriture d'ajustement du Wallet"
