...
#: Roles internes a privilege : la double authentification est obligatoire,
#: pas seulement disponible. Ils voient des cases sensibles (vulnerabilites
#: non corrigees sur des systemes gouvernementaux) : un compte compromis par
#: simple vol de mot de passe y est inacceptable.
MFA_REQUIRED_ROLES = NATIONAL_ROLES | ORGANIZATION_ROLES
